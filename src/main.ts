...
import { faPencil, faMagnifyingGlass, faUser, faArrowLeft, faTrash, faRotate, faChevronRight } from '@fortawesome/free-solid-svg-icons'

// Add only the icons we use (tree-shaking keeps the bundle small)
library.add(faPencil, faMagnifyingGlass, faUser, faArrowLeft, faTrash, faRotate, faChevronRight)
